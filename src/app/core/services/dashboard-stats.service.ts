...
import { ConsolidatedComparisonData, ConsolidatedDataParams, DailySummaryApiItem, DashboardResult, MonthlySummaryApiItem, PaginatedComparisonDetail, SummaryApiResult } from '../models/dashboard-api.model';
import { DateRange } from '../../features/dashboard/pages/statistics/models/dashboard-ui.model';
